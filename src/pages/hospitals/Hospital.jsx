...
import manipal from "../../assets/img/manipal.jpg";
import sakra from "../../assets/img/sakra.webp";
import suchirayu from "../../assets/img/suchirayu.png";
import hssh from "../../assets/img/hssh.png";
...
export default function Hospital() {
  ...
  return (
    <div className="flex flex-col min-h-screen p-4 md:p-6 bg-background w-full mt-16">
      ...
      {/* Hospital Cards using Custom Card Component */}
