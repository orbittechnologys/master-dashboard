    ...
    <div className="p-6 bg-[#f9fdfc] min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="md:col-span-2 mt-4">
          <h2 className="text-lg font-semibold text-gray-700 mb-2">Address Details</h2>
        </div>
        ...
        {/* POC Details Heading */}
        <div className="md:col-span-2 mt-4">
          <h2 className="text-lg font-semibold text-gray-700 mb-2">Hospital Admin / POC Details</h2>
        </div>
